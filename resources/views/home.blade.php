                        ...
                        @foreach($ranges as $i => $range)
                            <tr>
                                <td>
                                    {{ $range['min'] }} -
                                    {{ $range['max'] }}
                                    <input type="hidden" name="ranges[{{ $i }}][min]"
                                        value="{{ $range['min'] }}">
                                    <input type="hidden" name="ranges[{{ $i }}][max]"
                                        value="{{ $range['max'] }}">
                                </td>
                                <td>
                                    <input type="number" name="ranges[{{ $i }}][company]"
                                        class="form-control margin-input" data-row="{{ $i }}" data-role="company"
                                        value="{{ $range['company'] }}">
                                </td>
                                <td>
                                    <input type="number" name="ranges[{{ $i }}][distributor]"
                                        class="form-control margin-input" data-row="{{ $i }}" data-role="distributor"
                                        value="{{ $range['distributor'] }}">
                                </td>
                                <td>
                                    <input type="number" name="ranges[{{ $i }}][shop]" class="form-control margin-input"
                                        data-row="{{ $i }}" data-role="shop"
                                        value="{{ $range['shop'] }}">
                                </td>
